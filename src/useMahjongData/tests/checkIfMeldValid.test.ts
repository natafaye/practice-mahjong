...
describe("checkIfMeldValid", () => {
  describe("Edge Cases, Limits, and Basic Standard Suits", () => {
    ...
    it("should reject a pair of standard number tiles if one is a Joker", () => {
      ...
      expect(checkIfMeldValid(meld)).toBe(false);
    });
