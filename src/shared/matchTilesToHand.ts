...
import type { MahjongHand, MahjongHandMeld, MahjongTile } from "../types";
 ...
 */
export const matchTilesToHand = (tiles: MahjongTile[], hand: MahjongHand) => {
  let bestMatches = -1;
...
// Generates all possible string combinations for a hand's melds (to handle runs, any pair, any matching, etc)
