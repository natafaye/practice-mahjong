...
import { selectMelding, selectCallingPlayer } from '../_store/selectors';
...
import JokerSwapDropOverlay from './JokerSwapDropOverlay';
  ...
  return (
    <div className={clsx("relative")} style={{ background: rackLight }}>
      {player.index === THIS_PLAYER && <>
        ...
        <JokerSwapDropOverlay playerIndex={THIS_PLAYER} />
      </>}
      <div className={clsx(
