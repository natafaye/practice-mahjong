...
export const peachTheme: Theme = {
  ...
  table: "color-mix(in srgb, #eabbab, white 20%)",
  tableMid: "#eabbab",
...
export const serenityTheme: Theme = {
    ...
    table: "color-mix(in srgb, #E5E5E5, white 20%)",
    tableMid: "#E5E5E5",
...
export const blossomTheme: Theme = {
    ...
    table: "color-mix(in srgb, #F2DED3, white 20%)",
    tableMid: "#F2DED3",
...
export const coastTheme: Theme = {
    ...
    table: "color-mix(in srgb, #F8F1C3, white 20%)",
    tableMid: "#F8F1C3",
...
export const natureTheme: Theme = {
    ...
    table: "color-mix(in srgb, #C9BD88, white 20%)",
    tableMid: "#C9BD88",
...
export const springTheme: Theme = {
    ...
    table: "color-mix(in srgb, #EDE6CF, white 20%)",
    tableMid: "#EDE6CF",
